...
const FOOD_DATABASE = [
    ...
    // PRE-WORKOUT CARBS (PURE CARBS ONLY - NO PROTEIN/FAT)
    { name: 'Banana', category: 'Pre-Workout', protein: 0.1, carbs: 27.0, fats: 0.0, calories: 105 },
    { name: 'Apple', category: 'Pre-Workout', protein: 0.1, carbs: 14.0, fats: 0.0, calories: 52 },
    { name: 'Dates (3-4 pieces)', category: 'Pre-Workout', protein: 0.1, carbs: 75.0, fats: 0.0, calories: 282 },
    { name: 'Raisins', category: 'Pre-Workout', protein: 0.1, carbs: 79.0, fats: 0.0, calories: 299 },
    { name: 'Honey (1-2 tbsp)', category: 'Pre-Workout', protein: 0.0, carbs: 82.0, fats: 0.0, calories: 304 },
    { name: 'Orange Juice', category: 'Pre-Workout', protein: 0.1, carbs: 11.0, fats: 0.0, calories: 45 },
